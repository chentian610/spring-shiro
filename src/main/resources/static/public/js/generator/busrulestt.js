$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '语音识别出来的文本', name: 'tts', index: 'tts', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.busRuleStt.id == null ? "../busrulestt/save" : "../busrulestt/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.busRuleStt),
			    success: function(r){
			    	if(r.code === 0){
		...
		getInfo: function(id){
			$.get("../busrulestt/info/"+id, function(r){
                vm.busRuleStt = r.busRuleStt;
            });
		},
